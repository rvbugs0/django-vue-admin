...
var trustedGlobals = [].concat((0, _toConsumableArray2.default)(_without2.default.apply(void 0, [_globals.globals].concat(spiedGlobals))), ['requestAnimationFrame']);
exports.trustedGlobals = trustedGlobals;
