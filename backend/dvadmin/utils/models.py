...
class SoftDeleteModel(models.Model):
    ...
    一旦继承,就将开启软删除
    """
    is_deleted = models.BooleanField(verbose_name="Soft Delete", help_text='Soft Delete', default=False, db_index=True)
...
class CoreModel(models.Model):
    ...
    description = models.CharField(max_length=255, verbose_name="Remark", null=True, blank=True, help_text="Remark")
    creator = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_query_name='creator_query', null=True,
                                verbose_name='Creator', help_text="Creator", on_delete=models.SET_NULL, db_constraint=False)
    modifier = models.CharField(max_length=255, null=True, blank=True, help_text="Updater", verbose_name="Updater")
    dept_belong_id = models.CharField(max_length=255, help_text="Department", null=True, blank=True, verbose_name="Department")
    update_datetime = models.DateTimeField(auto_now=True, null=True, blank=True, help_text="Update Time", verbose_name="Update Time")
